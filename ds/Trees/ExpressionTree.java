public class ExpressionTree{
    ...
    public double evaluate(){
      ...
      if(this.isOperator()){
        double leftEval = this.left.evaluate();
        double rightEval = this. right.evaluate();
        return apply(leftEval, rightEval, this.operator);
      }else{
        return value;
      }
    ...
    public String toString(){
      ...
      if(this.isOperator()){
        String leftChild = this.left.toString();
        String rightChild = this.right.toString();
        treeString += "(" + leftChild + this.operator + rightChild + ")";
      }else{
        treeString += this.value;
      }
      return treeString;
