 ...
 * Collaborators: Jihae Park, Shana Elizabeth Henry, AliseBraick, Jing Xue
 */
...
public class Time {
    ...
    //default constructors - review the keyword "this"
    public Time(){
    	this.hours = 0;
    	this.minutes = 0;
    	this.seconds = 0;
    ...
    */
    public String toString(){
	    return( hrs + ":"  + mins + ":" + se"This should be changed to return the time in a nice form");
    }
